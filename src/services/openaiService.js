...
const sendMessagesToOpenAI = async (catDetails, messages) => {
  try {
    const response = await openai.chat.completions.create({
      model: "gpt-4o-mini",
      messages: [
